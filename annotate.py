...
EXTRA_MEANINGS = {
    ...
    # --- Archaic/Ottoman words batch 3 (from full scan) ---
    'abâ': 'Kaba yün elbise',
    'agyâr': 'Yabancılar, düşmanlar',
    'akdarur': 'Devirir, yıkar',
    'bayık': 'Gerçek, doğru',
    'bed-nâm': 'Kötü şöhretli',
    'berât': 'Ferman, berat',
    'beşâret': 'Müjde',
    'bid\'at': 'Dinde sonradan uydurulmuş şey',
    'bâl u per': 'Kanat',
    'bârigâh': 'Dergâh, huzur',
    'bâzirgân': 'Tüccar',
    'bî-gümân': 'Şüphesiz',
    'bî-hod': 'Kendinden geçmiş',
    'bî-pâyân': 'Sonsuz, nihayetsiz',
    'bürhân': 'Kesin delil, ispat',
    'cevlân': 'Dolaşma, gezinme',
    'cur\'a': 'Yudum',
    'dehrî': 'Dinsiz, materyalist',
    'destâr': 'Sarık',
    'dâg': 'Yara, dağlama izi',
    'dînâr': 'Altın para',
    'dükeli': 'Bütün, tümü',
    'düşvâr': 'Güç, zor',
    'endîşe': 'Düşünce, kaygı',
    'eşker': 'Açık, aşikâr',
    'farîza': 'Farz olan ibadet',
    'ferişteh': 'Melek (Farsça)',
    'ferrâş': 'Döşekçi, hizmetçi',
    'fidî': 'Feda, kurban',
    'galaba': 'Kalabalık, gürültü',
    'gammâz': 'Dedikoducu, ispiyoncu',
    'ganîmet': 'Fırsat, değerli kazanç',
    'gavvâs': 'Dalgıç, inci arayan',
    'gedâ': 'Dilenci, fakir',
    'genc-i nihân': 'Gizli hazine',
    'giryân': 'Ağlayan',
    'gümân': 'Şüphe, zan',
    'güzer': 'Geçiş, geçme',
    'halvet': 'Baş başa kalma, yalnızlık',
    'halâs': 'Kurtuluş, kurtulma',
    'halâyık': 'Yaratıklar, halk',
    'handân': 'Gülen, sevinçli',
    'harcısı': 'Karşılığı, bedeli',
    'harâbât': 'Meyhane, virane',
    'harîdâr': 'Müşteri, alıcı',
    'harîr': 'İpek',
    'hazer': 'Sakınma, dikkat',
    'haşr': 'Kıyamette toplanma',
    'haşre': 'Kıyamette toplanmaya',
    'hezâr': 'Bin (Farsça)',
    'hezârân': 'Binlerce',
    'hil\'at': 'Kaftan, onur elbisesi',
    'hâce': 'Hoca, efendi',
    'hüccet': 'Delil, kanıt',
    'hülâsa': 'Özet, öz',
    'icâzet': 'Diploma, izin belgesi',
    'ihlâs': 'Samimiyet, içtenlik',
    'iklîm': 'Ülke, diyar',
    'intizâr': 'Bekleme, gözleme',
    'irfân': 'Marifet, gerçek bilgi',
    'istigfâr': 'Allah\'tan bağışlanma dileme',
    'itâb': 'Azarlama, kınama',
    'kanâ\'at': 'Yetinme, azla yetinme',
    'katre': 'Damla',
    'keleci': 'Söz, kelâm',
    'kilîd': 'Kilit',
    'kâ\'im': 'Ayakta duran, kıyamda',
    'kâlû belî': 'Elest bezminde "Evet" dedik',
    'libâs': 'Elbise, giysi',
    'magfûr': 'Bağışlanmış',
    'mahfil': 'Meclis, toplantı yeri',
    'mahlûkât': 'Yaratılmışlar, canlılar',
    'meded': 'Yardım, imdat',
    'medh': 'Övgü',
    'melâmet': 'Kınama, ayıplama',
    'melûl': 'Üzgün, kederli',
    'menşûr': 'Ferman, berat',
    'merdâne': 'Mertçe, yiğitçe',
    'mestûr': 'Örtülü, gizli',
    'metâ': 'Mal, değerli şey',
    'meşâyıh': 'Şeyhler',
    'mi\'râc': 'Hz. Peygamber\'in göğe yükselişi',
    'mihrâb': 'Namaz kılınan yer, niş',
    'mikdâr': 'Ölçü, değer',
    'mu\'allak': 'Asılı, havada duran',
    'mülk-i bekâ': 'Sonsuzluk yurdu, âhiret',
    'münevver': 'Aydınlanmış, nurlu',
    'münâcât': 'Allah\'a yakarış, dua',
    'müştâk': 'Özleyen, hasret çeken',
    'na\'lın': 'Ayakkabı, terlik',
    'nigâr': 'Sevgili, güzel',
    'nikâb': 'Yüz örtüsü, perde',
    'nisâr': 'Saçma, serpme',
    'nâ-gehân': 'Ansızın, birdenbire',
    'nâdân': 'Cahil, bilgisiz',
    'nâkûs': 'Çan (kilise çanı)',
    'nûş': 'İçme',
    'pehlevân': 'Kahraman, güreşçi',
    'pervâz': 'Uçuş, kanat çırpma',
    'perâkende': 'Dağınık, perişan',
    'peymâne': 'Kadeh, içki bardağı',
    'peşmân': 'Pişman',
    'pinhân': 'Gizli',
    'pâs': 'Kir, pas (gönül pası)',
    'riyâ': 'Gösteriş, ikiyüzlülük',
    'riyâzât': 'Nefsi terbiye çileleri',
    'rûzigâr': 'Zaman, devir',
    'salât': 'Namaz',
    'sarrâf': 'Kuyumcu, değer biçen',
    'sayvân': 'Gölgelik, çadır',
    'sebak': 'Ders',
    'selâsil': 'Zincirler',
    'semâ': 'Tasavvufî dönme ayini',
    'ser-gerdân': 'Başı dönmüş, şaşkın',
    'ser-te-ser': 'Baştan başa, tamamen',
    'seyrân': 'Gezinti, seyir',
    'sâ\'im': 'Oruçlu',
    'sâlûs': 'İkiyüzlü, riyakâr',
    'sûz': 'Yanma, ateş',
    'tarîk': 'Yol',
    'teferrüc': 'Gezinti, seyir',
    'teneşür': 'Teneşir, ölü yıkama tahtası',
    'teşvîş': 'Karışıklık, endişe',
    'tûl-ı emel': 'Uzun emeller, bitmeyen hırs',
    'ummân': 'Okyanus, engin deniz',
    'yarlıgamak': 'Bağışlamak, affetmek',
    'zebânî': 'Cehennem azap melekleri',
    'zebûn': 'Güçsüz, aciz',
    'âreste': 'Süslenmiş, düzenlenmiş',
